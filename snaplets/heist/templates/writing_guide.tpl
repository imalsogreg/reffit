...
<h3>Write for the community</h3>
<p>Our main goal is to build up, not tear down. The health of the community comes from the quest for improvement. When improvement means pointing out flaws in a study, try to find a way to make your criticism as constructive as possible.</p>

<h3>Less is more</h3>
<p>We want as many high-quality ideas visible on the page as possible.  That means trying to keep your idea pithy - one or two short sentences. Let your idea be judged for its content, not its rhetorical flare. If you want more space to set up or break down your comment, use your comment's Discussion leaf.</p>

<h3>Vote!</h3>
<p>If someone the point similar to the one you've been burning to write, it's fine to add your version. But don't forget to show your love for the other comment with a vote, if it was made well!</p>

<h3>Cross-posting</h3>
<p>Yes! If you wrote a thorough review on Publons, break it out into independent points for Reffit.  If you see a way to synthesize several Reffit points into a whole review for Publons, get in touch with the Reffit users whose points you want to use.</p>
